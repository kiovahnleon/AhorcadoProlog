...
draw_gallows1 :-
    nl, nl, nl, nl, nl, nl, nl, write('   -----').

draw_gallows2 :-
    nl, write('     |  '), nl, write('     |  '), nl, write('     |  '), nl, write('     |  '), nl, write('   -----').

draw_gallows3 :-
    nl, write('  ---|  '), nl, write('     |  '), nl, write('     |  '), nl, write('     |  '), nl, write('     |  '), nl, write('   -----').

draw_gallows4 :-
    nl, write('  ---|  '), nl, write('  |  |  '), nl, write('     |  '), nl, write('     |  '), nl, write('     |  '), nl, write('   -----').

draw_gallows5 :-
    nl, write('  ---|  '), nl, write('  |  |  '), nl, write('  O  |  '), nl, write('     |  '), nl, write('     |  '), nl, write('   -----').

draw_gallows6 :-
    nl, write('  ---|  '), nl, write('  |  |  '), nl, write('  O  |  '), nl, write('  |  |  '), nl, write('     |  '), nl, write('   -----').

draw_gallows7 :-
    nl, write('  ---|  '), nl, write('  |  |  '), nl, write(' _O_ |  '), nl, write('  |  |  '), nl, write('     |  '), nl, write('   -----').

draw_gallows8 :-
    nl, write('  ---|  '), nl, write('  |  |  '), nl, write(' _O_ |  '), nl, write('  |  |  '), nl, write(' //  |  '), nl, write('   -----'), nl,
    write('*****************************************************'), nl,
    write('You have lost the game!'), nl,
    write('Write play. to play again.'), nl,
    write('*****************************************************'), nl, nl.
